...
function create_acc() {
	...
	$labels = array(
		'name' => 'Accreditation',
		 ...
		 'parent' => 'Parent Accreditation'
	);
	$args = array(
		'labels' => $labels,
		'description' => 'Create new accreditation for ELI. These are displayed on the homepage',
		'public' => true,
		'show_ui' => true,
		'show_in_menu' => true,
		'capability_type' => 'page',
...
/*add_action( 'init', 'create_new_sidebars' );
function create_new_sidebars() {
	...
	$labels = array(
		'name' => 'Sidebars',
		 ...
		 'parent' => 'Parent Sidebars'
	);
	$args = array(
		'labels' => $labels,
		'description' => 'Create new sidebars for ELI. These are displayed on all pages',
		'public' => true,
		'show_ui' => true,
		'show_in_menu' => true,
		'capability_type' => 'page',
...
function create_new_gallery() {
	...
	$args = array(
		...
		'map_meta_cap' => true,
		'hierarchical' => false,
		'rewrite' => array('slug' => '/resources/student-gallery/gallery'),
		'query_var' => true,
		'exclude_from_search' => true,
		'menu_position' => 36,
		'menu_icon' => get_bloginfo('template_directory') . '/library/images/custom-post-icon.png',  // Icon Path
