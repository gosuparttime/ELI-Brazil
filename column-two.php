...
<div class="clearfix">
  <?php 
            ...
            ?>
  <a class="btn btn-block" href="/for-students/stories-from-our-students/"><i class="icon-arrow-right"></i>See More Stories</a> </div>
...
<div class="clearfix pad-two-b">
  <?php 
			...
			$filez_button .='" blank="true" icon="icon-download-alt" color="info"';
